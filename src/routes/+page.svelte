<script>
	...
	import {
		...
		NetworkAllowed,
		FetchComponent
	} from '@douganderson444/svelte-component-gateway';

	// import { NetworkIsolated, NetworkAllowed, FetchComponent } from '../../package/index.js';
		...
		<FetchComponent {url} let:component>
			...
			>
				{#if component}
					...
					<NetworkIsolated esModule={component} {props} {width} {height} on:change={handleChange} />
					<!-- <PanHandle /> -->
					<!-- <Resizer /> -->
				{/if}
			</div>
